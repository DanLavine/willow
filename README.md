...
I want to work on at a glance:
  1. Add some additional docs to the services themselves for large features I would like from them

  2. Update the build scripts to include the Willow Service as well

  3. Simplify the Locker client
  ...
  4. Simplify the clients and ensure the API is properly documented with failure status codes
