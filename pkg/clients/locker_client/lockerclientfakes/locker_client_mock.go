...
//
//	mockgen -destination=lockerclientfakes/locker_client_mock.go -package=lockerclientfakes github.com/DanLavine/willow/pkg/clients/locker_client LockerClient
//
...
func (m *MockLockerClient) ObtainLock(arg0 context.Context, arg1 *v1.Lock, arg2 func(datatypes.KeyValues, error)) (lockerclient.Lock, error) {
	m.ctrl.T.Helper()
...
func (mr *MockLockerClientMockRecorder) ObtainLock(arg0, arg1, arg2 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
