...
var (
	sessionIDEmpty              = fmt.Errorf("'SessionID' is the empty string. There is a server error wher this is not recording properly")
	keyValuesLenghtInvalid      = fmt.Errorf("'KeValues' is empty, but requires a length of at least 1")
