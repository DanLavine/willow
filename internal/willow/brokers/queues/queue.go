...
//
//go:generate mockgen -destination=queuesfakes/managed_queue_mock.go -package=queuesfakes github.com/DanLavine/willow/internal/willow/brokers/queues ManagedQueue
