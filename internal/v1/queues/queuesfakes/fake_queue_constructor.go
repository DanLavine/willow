...
type FakeQueueConstructor struct {
	NewQueueStub        func(*v1.Create) (queues.Queue, *v1.Error)
...
func (fake *FakeQueueConstructor) NewQueue(arg1 *v1.Create) (queues.Queue, *v1.Error) {
...
func (fake *FakeQueueConstructor) NewQueueCalls(stub func(*v1.Create) (queues.Queue, *v1.Error)) {
	fake.newQueueMutex.Lock()
...
func (fake *FakeQueueConstructor) NewQueueReturns(result1 queues.Queue, result2 *v1.Error) {
	fake.newQueueMutex.Lock()
	defer fake.newQueueMutex.Unlock()
...
func (fake *FakeQueueConstructor) NewQueueReturnsOnCall(i int, result1 queues.Queue, result2 *v1.Error) {
	fake.newQueueMutex.Lock()
	defer fake.newQueueMutex.Unlock()
	fake.NewQueueStub = nil
