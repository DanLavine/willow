...
// 3. each ValueNode is a struct contains a slice of [][]uint64, where the 1st index is how many keys comprise a unique index.
// I.E:
//
...
type bTreeAssociated interface {
	...
	Search(selection query.Select, onFindSelection datastructures.OnFindSelection) error
